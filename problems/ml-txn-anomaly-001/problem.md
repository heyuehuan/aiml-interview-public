...
Reviewers can review at most **200 transactions per day**; the current rule-based
system floods them with low-quality alerts. You have six months of historical
transactions, a subset of which were reviewed and labeled.
...
- A short (~half page) summary: approach, key decisions, what you'd do next.
